...
static struct sgxlkl_config_elem sgxlkl_config[] = {
 ...
 /* 46 */ {"SGXLKL_SYSCTL",                   "sysctl",                   TYPE_CHAR, {.def_char = NULL}, 0},
 ...
 /* 57 */ {"SGXLKL_WAIT_ON_HOST_CALLS",       "wait_on_host_calls",       TYPE_BOOL, {.def_bool = 0}, 0},
 /* 58 */ {"SGXLKL_WAIT_ON_IO_HOST_CALLS",    "wait_on_io_host_calls",    TYPE_BOOL, {.def_bool = 0}, 0},
